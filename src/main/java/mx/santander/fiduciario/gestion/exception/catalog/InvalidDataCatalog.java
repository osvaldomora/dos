package mx.santander.fiduciario.gestion.exception.catalog;
...
public enum InvalidDataCatalog {
	...
	INVD003("InvalidDataException003","INVD.003","Dato no valido.",HttpStatus.CONFLICT,LevelException.ERROR);
